...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\app.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//                 <small></small>
	//             </div>
	//             <a href="#" class="o2_cover_btn" :onclick="flag.needLoadSign=true;">立即生成签名</a>
	//         </div>
	//     </div>
	//     <warn :show-browser-unsupport="flag.showBowserUnsupport"></warn>
	//     <main :show-color-setting="flag.showColorSetting" :style="style" :info="info"></main>
	//     <cropper :cropper="cropper" :img-has-load="imgHasLoad"></cropper>
	// </div>
	// </template>
	// <script>
	var Cropper = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\components\\cropper.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    methods: {
	        finishCropImage: function finishCropImage() {
	            var thisObj = this;
	...
	//   .o2_alert .o2_alert_close {
	//     position: absolute;
	//     width: 30px;
	//     height: 30px;
	//     top: 0;
	//     right: 0; }
	//     .o2_alert .o2_alert_close:after {
	//       position: absolute;
	//       top: 50%;
	//       left: 50%;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\components\\warn.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	// <template>
	//     <div class="o2_warn" v-bind:class="{'show' : showBrowserUnsupport}">
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\components\\main.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <template>
	//     <div class="o2_main" v-bind:class="{'show':needLoadSign}" >
	// 		<span class="o2_main_close" v-on:click="needLoadSign=false;"></span>
	// 		<!-- S preview -->
	//         <preview :style="style" :info="info"></preview>
	// 		<!-- E preview -->
	//
	// 		<!-- S content -->
	// 		<content :style="style" :info="info" :show-color-setting="showColorSetting" ></content>
	// 		<!-- E content-->
	// 	</div>
	// </template>
	// <script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\components\\content.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 			<div class="o2_content_slider" v-bind:class="{'slide':showColorSetting}">
	// 				<!-- S input -->
	// 				<div class="o2_form">
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\Learning\\Vue-Learning\\vue-test\\src\\components\\preview.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 			<span class="o2_color_setting" title="配色设置" v-on:click="showColorSetting = !showColorSetting">配色</span>
	// 			<div class="o2_sign" id="sign" :style="{ backgroundColor:style.co_bg }" >
	// 				<div class="logo">
	// 					<img src="=" alt="logo" v-on:click="showColorSetting = !showColorSetting">
	// 				</div>
	// 				<div class="img">
	// 					<img src="" alt="头像">
	// 				</div>
	...
	module.exports = {
	    props: ['showColorSetting', 'style', 'info']
	};
	// </script>
	/* generated by vue-loader */
...
/***/ function(module, exports) {
	...
	module.exports = "\r\n    <div class=\"o2_box\">\r\n\t\t\t<span class=\"o2_box_type\">预览</span>\r\n\t\t\t<span class=\"o2_color_setting\" title=\"配色设置\" v-on:click=\"showColorSetting = !showColorSetting\">配色</span>\r\n\t\t\t<div class=\"o2_sign\" id=\"sign\" :style=\"{ backgroundColor:style.co_bg }\" >\r\n\t\t\t\t<div class=\"logo\">\r\n\t\t\t\t\t<img src=\"=\" alt=\"logo\" v-on:click=\"showColorSetting = !showColorSetting\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"img\">\r\n\t\t\t\t\t<img src=\"xxxHTMLLINKxxx0.71916305925697090.6873547076247633xxx\" alt=\"头像\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"line\" :style=\"{ backgroundColor:style.co_line }\"></div>\r\n\t\t\t\t<div class=\"info\">\r\n\t\t\t\t\t<div class=\"title\" :style=\"{ color:style.co_title }\">\r\n\t\t\t\t\t\t<p class=\"e_name\" v-text=\"info.e_name? info.e_name : 'NAME'\"></p>\r\n\t\t\t\t\t\t<p class=\"c_name\" v-text=\"info.c_name ? info.c_name:'姓名'\"></p>\r\n\t\t\t\t\t\t<div class=\"hr\" :style=\"{ backgroundColor:style.co_title }\"></div>\r\n\t\t\t\t\t\t<p class=\"group\" v-text=\"info.group ? info.group:'所属部门'\"></p>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<div class=\"contact\" :style=\"{ color: style.co_item }\">\r\n\t\t\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t\t\t<i class=\"icon-mobile mobile\" :style=\"{ color:style.co_icon }\"></i>\t\r\n\t\t\t\t\t\t\t<p v-text=\"(info.contact.phone?info.contact.phone:'123-4567-8901') | formatTelNo \"></p>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t\t\t<i class=\"icon-call call\" :style=\"{ color:style.co_icon }\"></i>\r\n\t\t\t\t\t\t\t<p v-text=\"(info.contact.call?info.contact.call:'0755-32995555-1234') | formatOfficeNo\"></p>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t\t\t<i class=\"icon-qq qq\" :style=\"{ color:style.co_icon }\"></i>\r\n\t\t\t\t\t\t\t<p v-text=\"info.contact.qq ? info.contact.qq:'your QQ'\"></p>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t<div class=\"item\">\r\n\t\t\t\t\t\t\t<i class=\"icon-wechat wechat\" :style=\"{ color:style.co_icon }\"></i>\r\n\t\t\t\t\t\t\t<p v-text=\"info.contact.wechat ? info.contact.wechat:'your wechat'\"></p>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n";
